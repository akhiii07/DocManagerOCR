...
| 36 | **No rule consumes verification results yet** | Results are produced but nothing acts on them. A CERSAI charge hit should be a CRITICAL finding per `REQ_SARFAESI_26C`. Needs a verification-aware predicate. |
